This is my self-introduction to Django (yet in progress)...

In this repo I keep (for now) five branches. Each branch has an `md` file with my understandings of the topic. Maybe I put too much effort on the diagrams, but I also see this as a long term learning. 

You're currently in `main` branch. Here is where I discover the basics of Django projects and Django apps.

- In the branch `1-creating-a-model`, I go through how models get linked to tables in the database;
- In the branch `2-retrieving-objects-from-model`, I go through how you can retrieve data programmatically from the database via the model and Python methods (i.e., instead of SQL).
- In the branch `3-building-views`, I go through what is a view, how to add URL patterns for the views, and how to render view responses in HTML.
- In the branch `4-learning-rest-apis`, I go through how to create a RESTful API in Django.
